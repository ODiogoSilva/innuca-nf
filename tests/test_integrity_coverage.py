...
import shutil
import pytest
import templates.integrity_coverage as ic
...
def test_no_compression():
    ...
    fastq_path = "tests/test_data/sample.fastq"
...
def test_gzip_compression():
    ...
    fastq_path = "tests/test_data/sample_1.fastq.gz"
...
def test_bz2_compression():
    ...
    fastq_path = "tests/test_data/sample.fastq.bz2"
...
def test_zip_compression():
    ...
    fastq_path = "tests/test_data/sample.fastq.zip"
...
def test_full_run_files(temp_env):
    ...
    assert sorted(os.listdir(".")) == ['.fail', '.status', 'sample_coverage',
